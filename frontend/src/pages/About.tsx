        ...
        <div className="bg-luxury-black min-h-screen py-32 text-white">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-24 relative">
                    ...
                    <h2 className="text-luxury-gold text-sm tracking-[0.4em] uppercase mb-4 relative z-10">Our Heritage</h2>
                    <h1 className="text-5xl md:text-7xl font-serif mb-8 relative z-10">The Art of Automotive</h1>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto font-light leading-relaxed relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
                    <div className="relative">
                        ...
                        <img
                            ...
                            alt="Showroom"
                            className="relative z-10 w-full h-[500px] object-cover grayscale hover:grayscale-0 transition duration-700"
                        />
                    </div>
                    <div className="space-y-8">
                        <h2 className="text-4xl font-serif text-white">A Legacy of Trust</h2>
                ...
                <div className="border-t border-white/5 pt-24">
                    <div className="text-center mb-16">
                        <h2 className="text-2xl font-serif text-white mb-4">Financial Partners</h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-px bg-white/5 border border-white/5">
                        {[
                            ...
                            <div
                                key={index}
                                className="bg-luxury-black p-8 flex items-center justify-center group hover:bg-white/5 transition duration-500"
                            >
